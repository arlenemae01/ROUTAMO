...
if (isset($_POST["submit"])) {
    ...
    $query = "SELECT * FROM tbl_mo WHERE user_name = '$usernameemail' AND user_password = '$password'";
    ...
    if (mysqli_num_rows($result) > 0) {
        if ($password == $row['user_password']) {
            ...
            $insertQuery = "INSERT INTO login_user (usernameemail, fullname) VALUES ('$email', '$fullname')";
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center login-container">
        <form class="login-form text-center" action="" method="post">
            <img class="mb-5 logo" src="images/LOGO.png"/>
