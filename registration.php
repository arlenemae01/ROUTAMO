...
if(isset($_POST["submit"])){
    ...
    $duplicate = mysqli_query($conn, "SELECT * FROM tbl_mo WHERE user_name = '$EnterYourUsername' OR email = '$EnterYourEmail'");
    ...
    if(mysqli_num_rows($duplicate) > 0){
        ...
        if($CreateaPassword == $Confirmpassword){
            $query = "INSERT INTO tbl_mo (user_name, fullname, email, user_password) VALUES ('$EnterYourUsername','$EnterYourName','$EnterYourEmail','$CreateaPassword')";
    ...
    <div class="d-flex justify-content-center align-items-center login-container">
        <div class="form-group">
            ...
            <div class="form signup">
                ...
                <img class="mb-5 logo" src="images/LOGO.png"/></br>
